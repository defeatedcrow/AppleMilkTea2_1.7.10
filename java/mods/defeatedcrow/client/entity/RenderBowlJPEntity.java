...
import mods.defeatedcrow.common.block.BlockBowl;
...
public class RenderBowlJPEntity extends Render
{
     ...
     */
    public void render(PlaceableBowlJP entity, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
    	if (Util.getCupRender() == 1) return BowlJPTex1;
        else if (Util.getCupRender() == 2) return BowlJPTex2;
        else return BowlJPTex3;
    }
