...
{
    private static final ResourceLocation melonTextures = new ResourceLocation("defeatedcrow:textures/entity/anchormissile.png");
    ...
    public void renderMissile(EntityAnchorMissile par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
    	ModelAnchorMissile model = (ModelAnchorMissile) this.modelMissile;
    	boolean flag = false;
    	if (par1Entity.isActive()) flag = true;
