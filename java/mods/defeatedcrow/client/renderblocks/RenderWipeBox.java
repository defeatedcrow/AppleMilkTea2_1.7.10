	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		if (modelID == this.getRenderId())
		{
			if (block == DCsAppleMilk.wipeBox)
			{
				...
				{
					//bottom
					renderInvCuboid(renderer, block,  3.0F/16.0F, 0.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 8.0F/16.0F, 13.0F/16.0F,  this.boxIIcon);
				}
				else
				{
					renderInvCuboid(renderer, block,  3.0F/16.0F, 0.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 7.0F/16.0F, 4.0F/16.0F,  this.wipeIIcon[2]);
					renderInvCuboid(renderer, block,  3.0F/16.0F, 0.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 7.0F/16.0F, 13.0F/16.0F,  this.wipeIIcon[2]);
					renderInvCuboid(renderer, block,  3.0F/16.0F, 0.0F/16.0F, 4.0F/16.0F, 4.0F/16.0F, 7.0F/16.0F, 12.0F/16.0F,  this.wipeIIcon[3]);
					renderInvCuboid(renderer, block,  12.0F/16.0F, 0.0F/16.0F, 4.0F/16.0F, 13.0F/16.0F, 7.0F/16.0F, 12.0F/16.0F,  this.wipeIIcon[3]);
					renderInvCuboid(renderer, block,  3.0F/16.0F, 7.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 8.0F/16.0F, 13.0F/16.0F,  this.wipeIIcon[1]);
					renderInvCuboid(renderer, block,  4.0F/16.0F, 0.0F/16.0F, 4.0F/16.0F, 12.0F/16.0F, 1.0F/16.0F, 12.0F/16.0F,  this.wipeIIcon[0]);
				}
			}
