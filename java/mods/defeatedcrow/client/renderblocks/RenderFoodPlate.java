...
public class RenderFoodPlate implements ISimpleBlockRenderingHandler{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		if (modelID == this.getRenderId())
		{
			...
			{
				//base plate
				renderInvCuboid(renderer, block,  1.0F/16.0F, 0.0F/16.0F, 1.0F/16.0F, 15.0F/16.0F, 1.0F/16.0F, 15.0F/16.0F,  this.woodIIcon);
				renderInvCuboid(renderer, block,  2.0F/16.0F, 1.0F/16.0F, 2.0F/16.0F, 14.0F/16.0F, 3.0F/16.0F, 14.0F/16.0F,  this.plateIIcon);
				
				//meat
				renderInvCuboid(renderer, block,  4.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F, 14.0F/16.0F, 6.0F/16.0F, 9.0F/16.0F,  this.contentsIIcon);
				//side
			...
			{
				//dish
				renderInvCuboid(renderer, block,  2.0F/16.0F, 1.0F/16.0F, 2.0F/16.0F, 14.0F/16.0F, 2.0F/16.0F, 14.0F/16.0F,  this.dishIIcon);
				renderInvCuboid(renderer, block,  5.0F/16.0F, 0.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 1.0F/16.0F, 11.0F/16.0F,  this.dishIIcon);
				if (meta == 2)
				{
					//meat
