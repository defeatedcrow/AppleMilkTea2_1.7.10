...
public class RenderBowlRack implements ISimpleBlockRenderingHandler {
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		...
		if (modelID == this.getRenderId()) {
			...
			renderInvCuboid(renderer, block, 6.0F / 16.0F, 2.0F / 16.0F, 2.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
					3.0F / 16.0F, this.boxIcon);
			renderInvCuboid(renderer, block, 6.0F / 16.0F, 2.0F / 16.0F, 6.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
					7.0F / 16.0F, this.boxIcon);
			renderInvCuboid(renderer, block, 6.0F / 16.0F, 2.0F / 16.0F, 10.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
					11.0F / 16.0F, this.boxIcon);
			renderInvCuboid(renderer, block, 6.0F / 16.0F, 2.0F / 16.0F, 14.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
		...
		if (modelId == this.getRenderId()) {
			if (s == 0) {
				...
				if (m == 0 || m == 2) {
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(6.0F / 16.0F, 2.0F / 16.0F, 0.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
							1.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(6.0F / 16.0F, 2.0F / 16.0F, 3.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
							4.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(6.0F / 16.0F, 2.0F / 16.0F, 7.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
							8.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(6.0F / 16.0F, 2.0F / 16.0F, 11.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
							12.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(6.0F / 16.0F, 2.0F / 16.0F, 15.0F / 16.0F, 10.0F / 16.0F, 8.0F / 16.0F,
							16.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					...
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(0.0F / 16.0F, 2.0F / 16.0F, 6.0F / 16.0F, 1.0F / 16.0F, 8.0F / 16.0F,
							10.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(3.0F / 16.0F, 2.0F / 16.0F, 6.0F / 16.0F, 4.0F / 16.0F, 8.0F / 16.0F,
							10.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(7.0F / 16.0F, 2.0F / 16.0F, 6.0F / 16.0F, 8.0F / 16.0F, 8.0F / 16.0F,
							10.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(11.0F / 16.0F, 2.0F / 16.0F, 6.0F / 16.0F, 12.0F / 16.0F, 8.0F / 16.0F,
							10.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.boxIcon);
					block.setBlockBounds(15.0F / 16.0F, 2.0F / 16.0F, 6.0F / 16.0F, 16.0F / 16.0F, 8.0F / 16.0F,
							10.0F / 16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
				}
