...
public class RenderFilledBowl implements ISimpleBlockRenderingHandler{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		if (modelID == this.getRenderId())
		{
			...
			renderInvCuboid(renderer, block,  4.0F/16.0F, 1.0F/16.0F, 4.0F/16.0F, 12.0F/16.0F, 3.0F/16.0F, 12.0F/16.0F,  this.boxIIcon);
			
			renderInvCuboid(renderer, block,  3.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 5.0F/16.0F, 4.0F/16.0F,  this.boxIIcon);
			renderInvCuboid(renderer, block,  3.0F/16.0F, 2.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 5.0F/16.0F, 13.0F/16.0F,  this.boxIIcon);
			renderInvCuboid(renderer, block,  3.0F/16.0F, 2.0F/16.0F, 4.0F/16.0F, 5.0F/16.0F, 5.0F/16.0F, 12.0F/16.0F,  this.boxIIcon);
			...
			if (meta < 8)
			{
				if (meta == 0 || meta == 4)
				{
					renderInvCuboid(renderer, block,  4.0F/16.0F, 2.0F/16.0F, 4.0F/16.0F, 12.0F/16.0F, 7.0F/16.0F, 12.0F/16.0F,  this.contentsIIcon);
					renderInvCuboid(renderer, block,  5.0F/16.0F, 7.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 8.0F/16.0F, 11.0F/16.0F,  this.contentsIIcon);
				}
				renderInvCuboid(renderer, block,  4.0F/16.0F, 2.0F/16.0F, 4.0F/16.0F, 12.0F/16.0F, 4.0F/16.0F, 12.0F/16.0F,  this.contentsIIcon);
			}
