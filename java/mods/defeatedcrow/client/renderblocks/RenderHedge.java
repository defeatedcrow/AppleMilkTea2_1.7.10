		...
		if (modelId == this.getRenderId()) {
			if (!flag) {
				if (type == HedgeType.LATTICE) {
					...
					renderer.setOverrideBlockTexture(this.baseIcon);
					block.setBlockBounds(8 * f, 0 * f, 0 * f, 8 * f, 16 * f, 16 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(6 * f, 0 * f, 0 * f, 6 * f, 16 * f, 16 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(10 * f, 0 * f, 0 * f, 10 * f, 16 * f, 16 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					...
					renderer.setOverrideBlockTexture(this.baseIcon);
					block.setBlockBounds(4 * f, 0 * f, 1 * f, 12 * f, 7 * f, 15 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(3 * f, 0 * f, 0 * f, 13 * f, 8 * f, 16 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

				} else {
					renderer.setOverrideBlockTexture(this.baseIcon);
					block.setBlockBounds(4 * f, 0 * f, 1 * f, 12 * f, 15 * f, 15 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(3 * f, 0 * f, 0 * f, 13 * f, 16 * f, 16 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
				}
			} else {
				if (type == HedgeType.LATTICE) {
					...
					renderer.setOverrideBlockTexture(this.baseIcon);
					block.setBlockBounds(0 * f, 0 * f, 8 * f, 16 * f, 16 * f, 8 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(0 * f, 0 * f, 6 * f, 16 * f, 16 * f, 6 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(0 * f, 0 * f, 10 * f, 16 * f, 16 * f, 10 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(4 * f, 0 * f, 4 * f, 4 * f, 16 * f, 23 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					...
					renderer.setOverrideBlockTexture(this.baseIcon);
					block.setBlockBounds(1 * f, 0 * f, 4 * f, 15 * f, 7 * f, 12 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(0 * f, 0 * f, 3 * f, 16 * f, 8 * f, 13 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

				} else {
					renderer.setOverrideBlockTexture(this.baseIcon);
					block.setBlockBounds(1 * f, 0 * f, 4 * f, 15 * f, 15 * f, 12 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);

					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(0 * f, 0 * f, 3 * f, 16 * f, 16 * f, 13 * f);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
				}
			}
