...
public class RenderYuzuFence implements ISimpleBlockRenderingHandler{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		{
			//bottom
			renderInvCuboid(renderer, block,  6.0F/16.0F, 0.0F/16.0F, 6.0F/16.0F, 10.0F/16.0F, 1.0F/16.0F, 10.0F/16.0F,  this.bottomIcon);
			//flower
			renderInvCuboid(renderer, block,  8.0F/16.0F, 0.0F/16.0F, 0.0F/16.0F, 8.0F/16.0F, 16.0F/16.0F, 16.0F/16.0F,  this.fenceIcon);
		}
	}
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
		...
		if (modelId == this.getRenderId() && block instanceof BlockYuzuFence)
		{
			...
			if (fence.canConnectBlock(world, x, y, z-1, NORTH)) {
				...
				block.setBlockBounds(8.0F/16.0F, 0.0F/16.0F, 0.0F/16.0F, 8.0F/16.0F, 16.0F/16.0F, 8.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				
				renderer.setOverrideBlockTexture(this.bottomIcon);
				block.setBlockBounds(6.0F/16.0F, 0.0F/16.0F, 0.0F/16.0F, 10.0F/16.0F, 2.0F/16.0F, 6.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
			...
			if (fence.canConnectBlock(world, x, y, z+1, SOUTH)) {
				...
				renderer.setOverrideBlockTexture(this.fenceIcon);
				block.setBlockBounds(8.0F/16.0F, 0.0F/16.0F, 8.0F/16.0F, 8.0F/16.0F, 16.0F/16.0F, 16.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				
				renderer.setOverrideBlockTexture(this.bottomIcon);
				block.setBlockBounds(6.0F/16.0F, 0.0F/16.0F, 10.0F/16.0F, 10.0F/16.0F, 2.0F/16.0F, 16.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
			...
			if (fence.canConnectBlock(world, x-1, y, z, WEST)) {
				...
				renderer.setOverrideBlockTexture(this.fenceIcon);
				block.setBlockBounds(0.0F/16.0F, 0.0F/16.0F, 8.0F/16.0F, 8.0F/16.0F, 16.0F/16.0F, 8.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				
				renderer.setOverrideBlockTexture(this.bottomIcon);
				block.setBlockBounds(0.0F/16.0F, 0.0F/16.0F, 6.0F/16.0F, 6.0F/16.0F, 2.0F/16.0F, 10.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
			...
			if (fence.canConnectBlock(world, x+1, y, z, EAST)) {
				...
				renderer.setOverrideBlockTexture(this.fenceIcon);
				block.setBlockBounds(8.0F/16.0F, 0.0F/16.0F, 8.0F/16.0F, 16.0F/16.0F, 16.0F/16.0F, 8.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				
				renderer.setOverrideBlockTexture(this.bottomIcon);
				block.setBlockBounds(10.0F/16.0F, 0.0F/16.0F, 6.0F/16.0F, 16.0F/16.0F, 2.0F/16.0F, 10.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
			...
			{
				renderer.setOverrideBlockTexture(this.fenceIcon);
				block.setBlockBounds(8.0F/16.0F, 0.0F/16.0F, 0.0F/16.0F, 8.0F/16.0F, 16.0F/16.0F, 16.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				
				renderer.setOverrideBlockTexture(this.fenceIcon);
				block.setBlockBounds(0.0F/16.0F, 0.0F/16.0F, 8.0F/16.0F, 16.0F/16.0F, 16.0F/16.0F, 8.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
			}
			else
