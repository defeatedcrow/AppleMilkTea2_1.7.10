...
public class RenderCPanel implements ISimpleBlockRenderingHandler{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		if (modelID == this.getRenderId())
		{
			...
			if ((meta & 7) > 0)
			{
				renderInvCuboid(renderer, block,  0.0F/16.0F, 2.0F/16.0F, 0.0F/16.0F, 16.0F/16.0F, 2.01F/16.0F, 16.0F/16.0F,  this.topIcon);
			}
		...
		if (modelId == this.getRenderId())
		{
			if (meta < 8)
			{
				...
				if (meta > 0)
				{
					...
					block.setBlockBounds(0.0F/16.0F, 2.0F/16.0F, 0.0F/16.0F, 16.0F/16.0F, 2.01F/16.0F, 16.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
				}
			}
			else
			{
				...
				{
					renderer.setOverrideBlockTexture(this.topIcon);
					block.setBlockBounds(0.0F/16.0F, 1.0F/16.0F, 0.0F/16.0F, 16.0F/16.0F, 1.01F/16.0F, 16.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
				}
			}
