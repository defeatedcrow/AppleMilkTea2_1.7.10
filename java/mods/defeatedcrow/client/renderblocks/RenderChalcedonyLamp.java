...
public class RenderChalcedonyLamp implements ISimpleBlockRenderingHandler{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		if (modelID == this.getRenderId())
		{
			...
			{
				//頂点部分
				renderInvCuboid(renderer, block,  5.0F/16.0F, 14.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 16.0F/16.0F, 11.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  5.0F/16.0F, 0.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 2.0F/16.0F, 11.0F/16.0F,  this.IIcon4);
				
				//枠
				renderInvCuboid(renderer, block,  3.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F, 14.0F/16.0F, 4.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  3.0F/16.0F, 2.0F/16.0F, 12.0F/16.0F, 4.0F/16.0F, 14.0F/16.0F, 13.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  12.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 14.0F/16.0F, 4.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  12.0F/16.0F, 2.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 14.0F/16.0F, 13.0F/16.0F,  this.IIcon4);
				
				renderInvCuboid(renderer, block,  3.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F,  this.boxIIcon);
				renderInvCuboid(renderer, block,  12.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  3.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  3.0F/16.0F, 2.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F,  this.IIcon4);
				
				renderInvCuboid(renderer, block,  3.0F/16.0F, 13.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F, 14.0F/16.0F, 13.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  12.0F/16.0F, 13.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 14.0F/16.0F, 13.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  3.0F/16.0F, 13.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 14.0F/16.0F, 4.0F/16.0F,  this.IIcon4);
				renderInvCuboid(renderer, block,  3.0F/16.0F, 13.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 14.0F/16.0F, 13.0F/16.0F,  this.IIcon4);
				
				//中身
				renderInvCuboid(renderer, block,  4.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 12.0F/16.0F,  this.IIcon0);
			}
		}
		...
		if (modelId == this.getRenderId())
		{
			...
			else if (meta == 11)
			{
				if (DCsConfig.setAltTexturePass == 1)
				{
					//frame
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(3.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F, 13.0F/16.0F, 4.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(3.0F/16.0F, 2.0F/16.0F, 12.0F/16.0F, 4.0F/16.0F, 13.0F/16.0F, 13.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(12.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F, 13.0F/16.0F, 4.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(12.0F/16.0F, 2.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 13.0F/16.0F, 13.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(3.0F/16.0F, 2.0F/16.0F, 4.0F/16.0F, 4.0F/16.0F, 3.0F/16.0F, 12.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(12.0F/16.0F, 2.0F/16.0F, 4.0F/16.0F, 13.0F/16.0F, 3.0F/16.0F, 12.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(4.0F/16.0F, 2.0F/16.0F, 3.0F/16.0F, 12.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(4.0F/16.0F, 2.0F/16.0F, 12.0F/16.0F, 12.0F/16.0F, 3.0F/16.0F, 13.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(3.0F/16.0F, 12.0F/16.0F, 4.0F/16.0F, 4.0F/16.0F, 13.0F/16.0F, 12.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(12.0F/16.0F, 12.0F/16.0F, 4.0F/16.0F, 13.0F/16.0F, 13.0F/16.0F, 12.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(4.0F/16.0F, 12.0F/16.0F, 3.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 4.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(4.0F/16.0F, 12.0F/16.0F, 12.0F/16.0F, 12.0F/16.0F, 13.0F/16.0F, 13.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					...
					renderer.setOverrideBlockTexture(this.IIcon2);
					block.setBlockBounds(5.0F/16.0F, 13.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 14.5F/16.0F, 11.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon2);
					block.setBlockBounds(5.0F/16.0F, 0.5F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 2.0F/16.0F, 11.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(6.0F/16.0F, 14.5F/16.0F, 6.0F/16.0F, 10.0F/16.0F, 15.0F/16.0F, 10.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
					renderer.setOverrideBlockTexture(this.IIcon4);
					block.setBlockBounds(6.0F/16.0F, 0.0F/16.0F, 6.0F/16.0F, 10.0F/16.0F, 0.5F/16.0F, 10.0F/16.0F);
					renderer.setRenderBoundsFromBlock(block);
					renderer.renderStandardBlock(block, x, y, z);
