	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		...
		if (modelID == this.getRenderId()) {
			...
			renderInvCuboid(renderer, block, 2.0F / 16.0F, 1.0F / 16.0F, 2.0F / 16.0F, 14.0F / 16.0F, 2.0F / 16.0F,
					14.0F / 16.0F, this.bottomIIcon);
			renderInvCuboid(renderer, block, 2.0F / 16.0F, 0.0F / 16.0F, 2.0F / 16.0F, 4.0F / 16.0F, 1.0F / 16.0F,
					4.0F / 16.0F, this.bottomIIcon);
			renderInvCuboid(renderer, block, 2.0F / 16.0F, 0.0F / 16.0F, 12.0F / 16.0F, 4.0F / 16.0F, 1.0F / 16.0F,
					14.0F / 16.0F, this.bottomIIcon);
			renderInvCuboid(renderer, block, 12.0F / 16.0F, 0.0F / 16.0F, 2.0F / 16.0F, 14.0F / 16.0F, 1.0F / 16.0F,
					4.0F / 16.0F, this.bottomIIcon);
			renderInvCuboid(renderer, block, 12.0F / 16.0F, 0.0F / 16.0F, 12.0F / 16.0F, 14.0F / 16.0F, 1.0F / 16.0F,
					14.0F / 16.0F, this.bottomIIcon);
			// body
			renderInvCuboid(renderer, block, 1.0F / 16.0F, 2.0F / 16.0F, 1.0F / 16.0F, 15.0F / 16.0F, 8.0F / 16.0F,
					15.0F / 16.0F, this.boxIIcon);
			renderInvCuboid(renderer, block, 4.0F / 16.0F, 15.0F / 16.0F, 4.0F / 16.0F, 12.0F / 16.0F, 16.0F / 16.0F,
					12.0F / 16.0F, this.boxIIcon);
			// glass
			renderInvCuboid(renderer, block, 3.0F / 16.0F, 8.0F / 16.0F, 3.0F / 16.0F, 13.0F / 16.0F, 15.0F / 16.0F,
					13.0F / 16.0F, this.glassIIcon);
