...
public class RenderTeppann implements ISimpleBlockRenderingHandler{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		{
			//teppann
			renderInvCuboid(renderer, block,  0.0F/16.0F, 0.0F/16.0F, 0.0F/16.0F, 16.0F/16.0F, 2.0F/16.0F, 16.0F/16.0F,  this.plateIIcon);
			
			if (meta > 0 && meta < 5)//beef and pork
			{
				//meat
				renderInvCuboid(renderer, block,  2.0F/16.0F, 2.0F/16.0F, 5.0F/16.0F, 14.0F/16.0F, 6.0F/16.0F, 11.0F/16.0F,  this.contentsIIcon);
			}
			else if (meta == 5 || meta == 6)//chicken
			{
				renderInvCuboid(renderer, block,  4.0F/16.0F, 2.0F/16.0F, 4.0F/16.0F, 12.0F/16.0F, 6.0F/16.0F, 12.0F/16.0F,  this.contentsIIcon);
				renderInvCuboid(renderer, block,  4.0F/16.0F, 6.0F/16.0F, 6.0F/16.0F, 7.0F/16.0F, 8.0F/16.0F, 12.0F/16.0F,  this.contentsIIcon);
				renderInvCuboid(renderer, block,  9.0F/16.0F, 6.0F/16.0F, 6.0F/16.0F, 12.0F/16.0F, 8.0F/16.0F, 12.0F/16.0F,  this.contentsIIcon);
				renderInvCuboid(renderer, block,  4.0F/16.0F, 6.0F/16.0F, 12.0F/16.0F, 7.0F/16.0F, 8.0F/16.0F, 13.0F/16.0F,  this.contentsIIcon);
				renderInvCuboid(renderer, block,  9.0F/16.0F, 6.0F/16.0F, 12.0F/16.0F, 12.0F/16.0F, 8.0F/16.0F, 13.0F/16.0F,  this.contentsIIcon);
				
				renderInvCuboid(renderer, block,  4.0F/16.0F, 7.0F/16.0F, 13.0F/16.0F, 5.0F/16.0F, 8.0F/16.0F, 15.0F/16.0F,  this.dishIIcon);
				renderInvCuboid(renderer, block,  11.0F/16.0F, 7.0F/16.0F, 13.0F/16.0F, 12.0F/16.0F, 8.0F/16.0F, 15.0F/16.0F,  this.dishIIcon);
			}
			else if (meta == 7)//clam
			{
				renderInvCuboid(renderer, block,  5.0F/16.0F, 3.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F,  this.contentsIIcon);
				renderInvCuboid(renderer, block,  6.0F/16.0F, 2.0F/16.0F, 6.0F/16.0F, 10.0F/16.0F, 6.0F/16.0F, 10.0F/16.0F,  this.contentsIIcon);
			}
			else if (meta == 8)//clam
			{
				renderInvCuboid(renderer, block,  6.0F/16.0F, 2.0F/16.0F, 6.0F/16.0F, 10.0F/16.0F, 3.0F/16.0F, 9.0F/16.0F,  this.contentsIIcon);
				renderInvCuboid(renderer, block,  5.0F/16.0F, 3.0F/16.0F, 4.0F/16.0F, 11.0F/16.0F, 4.0F/16.0F, 11.0F/16.0F,  this.contentsIIcon);
				renderInvCuboid(renderer, block,  5.0F/16.0F, 4.0F/16.0F, 4.0F/16.0F, 11.0F/16.0F, 10.0F/16.0F, 5.0F/16.0F,  this.contentsIIcon);
				renderInvCuboid(renderer, block,  6.0F/16.0F, 5.0F/16.0F, 3.0F/16.0F, 10.0F/16.0F, 8.0F/16.0F, 4.0F/16.0F,  this.contentsIIcon);
				
				renderInvCuboid(renderer, block,  6.0F/16.0F, 3.0F/16.0F, 6.0F/16.0F, 10.0F/16.0F, 6.0F/16.0F, 10.0F/16.0F,  this.innerIIcon);
			}
			else if (meta == 9)//burnt meat
			{
				renderInvCuboid(renderer, block,  5.0F/16.0F, 2.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 3.0F/16.0F, 11.0F/16.0F,  this.contentsIIcon);
			}
