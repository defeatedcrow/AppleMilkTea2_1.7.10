...
import mods.defeatedcrow.client.model.model.ModelCanister;
...
public class TileEntityCanisterRenderer extends TileEntitySpecialRenderer {
	...
	private static final String[] canisterType = new String[] { "_milk", "_milk", "_sugar", "_maple", "_juice",
			"_nuts", "_berryjam" };
	public static TileEntityCanisterRenderer bottleRenderer;
	private ModelCanister bottleModel = new ModelCanister();

	public void renderTileEntityBottleAt(TileCanister par1Tile, double par2, double par4, double par6, float par8) {
	...
	public void setRotation(TileCanister par0Tile, float par1, float par2, float par3) {
		ModelCanister model = this.bottleModel;
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		this.renderTileEntityBottleAt((TileCanister) par1TileEntity, par2, par4, par6, par8);
	}
}
