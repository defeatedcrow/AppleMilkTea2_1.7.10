...
public class TileEntityProsessorRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation machineTex = new ResourceLocation("defeatedcrow:textures/entity/prosessor.png");
    private static final ResourceLocation glassTex = new ResourceLocation("defeatedcrow:textures/blocks/blueglass.png");
    public static TileEntityProsessorRenderer renderer;
    private ModelProsessor model = new ModelProsessor();
    ...
    {
        ModelProsessor model = this.model;
