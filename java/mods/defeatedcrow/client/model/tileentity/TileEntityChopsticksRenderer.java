...
import mods.defeatedcrow.client.model.model.ModelChopsticks;
...
public class TileEntityChopsticksRenderer extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation SticksTex = new ResourceLocation(Util.getEntityTexturePassNoAlt()
			+ "chopsticks.png");
	public static TileEntityChopsticksRenderer sticksRenderer;
	private ModelChopsticks sticksModel = new ModelChopsticks();

	public void renderTileEntitySticksAt(TileChopsticksBox par1TileSticks, double par2, double par4, double par6,
			float par8) {
