 ...
 * AMT2用のカスタムエクスプロージョン。
 * 目的は2つあり、
 * <br>・シルクメロン用の着火者、ドロップアイテムを消さない爆発
 * <br>・アンカーミサイル用飛行特効
 * <br>すべての場合でブロックを破壊しない。
 * */
public class CustomExplosion extends Explosion{
	...
	public CustomExplosion(World world, Entity source, EntityLivingBase ign, 
			double posX, double posY, double posZ, float size, Type t, boolean smoke) {
