    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
        	if (brk)
        	{
        		...
        		if (i1 == Blocks.stone || (i1.getItemDropped(meta, itemRand, 0) == null || i1.quantityDropped(meta, 0, itemRand) == 0))
        		{
        			par3World.setBlockToAir(par4, par5, par6);
            		par3World.playSoundEffect((double)((float)par4 + 0.5F), (double)((float)par5 + 0.5F), (double)((float)par6 + 0.5F), i1.stepSound.getBreakSound(), (i1.stepSound.getVolume() + 1.0F) / 2.0F, i1.stepSound.getPitch() * 0.8F);
