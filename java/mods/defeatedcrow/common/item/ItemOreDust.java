...
public class ItemOreDust extends Item {
	...
	private static final String[] itemType = new String[] {"iron", "tin", "copper",
		"silver", "lead", "gold", "nickel", "platinum"};
	...
	public String getUnlocalizedName(ItemStack par1ItemStack) {
		...
		return meta < 8 ? super.getUnlocalizedName() + "_" + this.itemType[meta] : super.getUnlocalizedName() + "_" + meta;
	}
