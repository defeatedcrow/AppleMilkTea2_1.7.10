...
public class ItemStrangeSlag extends Item{
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
		...
		if (ret != null && ret.getItem() != null)
		{
			...
			double bx = (double)(-MathHelper.sin(b / 180.0F * (float)Math.PI) *
					MathHelper.cos(b2 / 180.0F * (float)Math.PI));
			double bz = (double)(MathHelper.cos(b / 180.0F * (float)Math.PI) *
					MathHelper.cos(b2 / 180.0F * (float)Math.PI));
			double by = 0.15D;
			...
			EntityItem drop = new EntityItem(world, (double)((float)entityplayer.posX + a), (double)((float)entityplayer.posY + a1), (double)((float)entityplayer.posZ + a2), 
	...
	public ItemStack returnItem(ItemStack item, World world, EntityPlayer player)
	{
		...
		if (rand < 1)
		{
			...
			if (!gets.isEmpty())
			{
				...
				if (gets.get(r) != null) result = gets.get(r);
			}
		}
		else if (rand < 4)
		{
