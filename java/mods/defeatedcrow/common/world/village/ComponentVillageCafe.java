...
public class ComponentVillageCafe extends StructureVillagePieces.Village {
	...
	public ComponentVillageCafe(StructureVillagePieces.Start par1StartPiece, int par2, Random par3Random, StructureBoundingBox par4Box, int par5)
    {
	...
	public boolean addComponentParts(World world, Random random,
		...
		//ドア
		this.placeDoorAtCurrentPosition(world, structureboundingbox, random, 5, 2, 1, this.getMetadataWithOffset(Blocks.wooden_door, 3));
		this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, this.getMetadataWithOffset(Blocks.oak_stairs, 3), 5, 1, 0, structureboundingbox);
		...
		//花壇
		this.fillWithBlocks(world, structureboundingbox, 2, 1, 0, 3, 1, 0, Blocks.brick_block, Blocks.brick_block, false);
		this.fillWithBlocks(world, structureboundingbox, 8, 1, 3, 8, 1, 4, Blocks.brick_block, Blocks.brick_block, false);
