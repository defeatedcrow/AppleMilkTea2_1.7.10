...
public class ComponentVillageWarehouse extends StructureVillagePieces.Village {
	...
	public ComponentVillageWarehouse(StructureVillagePieces.Start par1StartPiece, int par2, Random par3Random, StructureBoundingBox par4Box, int par5)
    {
	...
	public boolean addComponentParts(World world, Random random,
		...
		//床
		this.fillWithBlocks(world, structureboundingbox, 0, 0, 1, 4, 2, 6, Blocks.cobblestone, Blocks.cobblestone, false);
		this.fillWithBlocks(world, structureboundingbox, 1, 1, 2, 3, 2, 5, Blocks.air, Blocks.air, false);
		this.fillWithBlocks(world, structureboundingbox, 1, 1, 2, 3, 1, 5, DCsAppleMilk.flintBlock, DCsAppleMilk.flintBlock, false);
		
		//柱
		this.fillWithBlocks(world, structureboundingbox, 0, 3, 1, 0, 4, 1, Blocks.cobblestone, Blocks.cobblestone, false);
		this.fillWithBlocks(world, structureboundingbox, 0, 3, 6, 0, 4, 6, Blocks.cobblestone, Blocks.cobblestone, false);
		this.fillWithBlocks(world, structureboundingbox, 4, 3, 1, 4, 4, 1, Blocks.cobblestone, Blocks.cobblestone, false);
		this.fillWithBlocks(world, structureboundingbox, 4, 3, 6, 4, 4, 6, Blocks.cobblestone, Blocks.cobblestone, false);
		...
		//ドア
		this.placeDoorAtCurrentPosition(world, structureboundingbox, random, 2, 2, 1, this.getMetadataWithOffset(Blocks.wooden_door, 3));
		this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, this.getMetadataWithOffset(Blocks.oak_stairs, 3), 2, 1, 0, structureboundingbox);
		...
		this.placeBlockAtCurrentPosition(world, Blocks.ladder, this.getMetadataWithOffset(Blocks.ladder, 0), 1, 5, 4, structureboundingbox);
		...
		if (!this.hasMadeChest)
        {
            ...
            if (structureboundingbox.isVecInside(j, i, k))
            {
                ...
                this.generateStructureChestContents(world, structureboundingbox, random, 3, 2, 4, ChestGenHooks.getItems(VILLAGE_BLACKSMITH, random), ChestGenHooks.getCount(VILLAGE_BLACKSMITH, random));
            }
        }
