...
public class DCsRecipeRegister {
		...
		GameRegistry.addShapelessRecipe(
		 ...
		 if (DCsConfig.enableMobBlock.length >= 5)
		 {
			 for(int i = 0; i < 5; i++)
			 {
				 ...
				 if (i == 1) item = new ItemStack(Items.bone, 8, 0);
				 else if (i == 2) item = new ItemStack(Items.spider_eye, 8);
				 else if (i == 3) item = new ItemStack(Items.ender_pearl, 8, 0);
				 else if (i == 4) item = new ItemStack(Items.slime_ball, 8, 0);
		 ...
		 GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{" X ","XYX"," X ",
	    			  Character.valueOf('Y'), new ItemStack(DCsAppleMilk.melonBomb, 1, 0),
		 ...
		 GameRegistry.addShapelessRecipe(
				 new ItemStack(Blocks.red_flower, 9),
				 new ItemStack(DCsAppleMilk.flowerPot, 1, 0));
		 
		 GameRegistry.addShapelessRecipe(
				 new ItemStack(Blocks.yellow_flower, 9),
				 new ItemStack(DCsAppleMilk.flowerPot, 1, 4));
		 ...
		 GameRegistry.addShapelessRecipe(
				 new ItemStack(DCsAppleMilk.dustWood, 8),
				 new ItemStack(DCsAppleMilk.woodPanel, 1, 0));
	}
		 ...
		 GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{
						 ...
						 "XYX",
						 " X ",
						 Character.valueOf('X'), new ItemStack(Blocks.obsidian, 1),
		 ...
		 for (int i = 0 ; i < 4 ; i++)
		 {
			 ...
			 GameRegistry.addRecipe(
					 ...
					 new Object[]{
						 ...
						 Character.valueOf('X'), new ItemStack(DCsAppleMilk.chalcedony, 1, i)
					 });
			 ...
			 GameRegistry.addRecipe(
					 ...
					 new Object[]{
						 ...
						 Character.valueOf('X'), new ItemStack(DCsAppleMilk.cLamp, 1, i)
					 });
		 }
	...
	static void addCordial() {//酒別にレシピがあり、量が多いので、for文で回しつつ個別メソッドを用意した
		...
		String[] alcohol = new String[] {"bottleShothu", "bottleGin", "bottleRum", "bottleVodka", "bottleWhiskey", "bottleBrandy"};
		...
		GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{
						 ...
						 "XZX",
						 " X ",
						 Character.valueOf('Z'), "slimeball",
						 Character.valueOf('X'), "logWood"}));
	...
	static void addMachines()
	{
		...
		GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{"XXX","XYX","XXX",
	    			  Character.valueOf('X'), new ItemStack(DCsAppleMilk.batteryItem, 1, 2),
	    			  Character.valueOf('Y'), "stickCarbon"}));
		...
		GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  ...
	    		  new Object[]{"XYX","YZY","XYX",
	    			  Character.valueOf('X'), "stickCarbon",
	    			  Character.valueOf('Y'), new ItemStack(Blocks.glass_pane, 1, 0),
	    			  Character.valueOf('Z'), new ItemStack(DCsAppleMilk.redGel, 1, 0)}));
		
		GameRegistry.addRecipe(
				 new ShapedOreRecipe(
	    		  new ItemStack(DCsAppleMilk.batBox, 1, 0),
	    		  new Object[]{"XYX","WZW","XVX",
	    			  Character.valueOf('X'), new ItemStack(Items.iron_ingot, 1, 0),
	    			  Character.valueOf('Y'), new ItemStack(Items.redstone, 1, 0),
	    ...
	    if(ingotSilver.size() > 0)
	    {
		    ...
		    GameRegistry.addRecipe(
					new ShapedOreRecipe(
			    		new ItemStack(ret.getItem(), 1, ret.getItemDamage()),
			    		new Object[]{"XXX","XXX","XXX",
			    		Character.valueOf('X'), new ItemStack(DCsAppleMilk.EXItems, 1, 10)}));
	    }
	    ...
	    if(ingotSteel.size() > 0)
	    {
		    ...
		    GameRegistry.addRecipe(
					new ShapedOreRecipe(
			    		new ItemStack(ret.getItem(), 1, ret.getItemDamage()),
			    		new Object[]{"XXX","XXX","XXX",
			    		Character.valueOf('X'), new ItemStack(DCsAppleMilk.EXItems, 1, 11)}));
	    }
	    ...
	    if(ingotLead.size() > 0)
	    {
		    ...
		    GameRegistry.addRecipe(
					new ShapedOreRecipe(
			    		new ItemStack(ret.getItem(), 1, ret.getItemDamage()),
			    		new Object[]{"XXX","XXX","XXX",
			    		Character.valueOf('X'), new ItemStack(DCsAppleMilk.EXItems, 1, 12)}));
	    }
