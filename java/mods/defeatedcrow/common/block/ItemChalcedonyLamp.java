...
public class ItemChalcedonyLamp extends ItemBlock{
	...
	private static final String[] type = new String[] {"_optionBlue", "_option", "_optionWhite", "_optionBlack", "_yazukaBlue", "_yazuka",
		"_yazukaWhite", "_yazukaBlack", "_burst", "_force", "_cube", "_sword"};
