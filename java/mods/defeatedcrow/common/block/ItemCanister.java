...
public class ItemCanister extends Item{
	...
	private static final String[] contents = new String[] {"milk", "soy", "sugar", "maple", "honey", "nuts", "berryjam"};
	
	private boolean repair;
	private static final Block thisBlockID = DCsAppleMilk.canister;
    ...
    public boolean itemInteractionForEntity(ItemStack itemstack, EntityPlayer player, EntityLivingBase entity)
    {
        if (itemstack != null && itemstack.getItemDamage() == 0 && entity instanceof EntityCow)
        {
            ...
            if (!target.isChild())
            {
        		...
        		if (!player.inventory.addItemStackToInventory(new ItemStack(this,1,112)))
            	{
            		player.entityDropItem(new ItemStack(this,1,112), 1);
            	}
            }
            return true;
        }
