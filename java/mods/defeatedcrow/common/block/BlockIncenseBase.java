...
public class BlockIncenseBase extends BlockContainer{
	...
	{
		AxisAlignedBB AABB = AxisAlignedBB.getBoundingBox((double)((float)x - area), (double)y - 1.0D, (double)((float)z - area), (double)((float)x + area), (double)y + 1.0D, (double)((float)z + area));
