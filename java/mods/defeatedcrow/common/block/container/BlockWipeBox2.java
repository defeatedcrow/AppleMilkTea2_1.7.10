...
public class BlockWipeBox2 extends BlockContainer{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else if (itemstack.getItem() == Items.paper || itemstack.getItem() == Item.getItemFromBlock(DCsAppleMilk.wipeBox))
		{
        	if (tile != null) {
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        short i = 0;
        TileWipeBox2 tile = (TileWipeBox2)par1World.getTileEntity(par2, par3, par2);
