...
public class ItemSilkyMelon extends ItemBlock{
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    EntitySilkyMelon entityMelon = new EntitySilkyMelon(par2World, (double)((float)i + 0.5F), (double)((float)j + 0.5F), (double)((float)k + 0.5F));
