...
public class BlockYuzuFence extends Block{
	...
	public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB aabb, List list, Entity entity)
    {
		...
		//中央の柱と柱上部は常に当たり判定がある
		AxisAlignedBB aabb1 = AxisAlignedBB.getBoundingBox((double)(x + f1), (double)y, (double)(z + f1), (double)(x + f2), (double)(y + 1.2), (double)(z + f2));
		...
		if (up)
		{
			AxisAlignedBB aabbU = AxisAlignedBB.getBoundingBox((double)(x + 0.25F), (double)(y + 1.4), (double)(z + 0.25F), (double)(x + 0.75F), (double)(y + 1.5), (double)(z + 0.75F));
		...
		if (north)
		{
			AxisAlignedBB aabbN = AxisAlignedBB.getBoundingBox((double)(x + f1), (double)(y), (double)(z + 0.0F), (double)(x + f2), (double)(y + 1.2), (double)(z + f1));
		...
		if (south)
		{
			AxisAlignedBB aabbS = AxisAlignedBB.getBoundingBox((double)(x + f1), (double)(y), (double)(z + f2), (double)(x + f2), (double)(y + 1.2), (double)(z + 1));
		...
		if (west)
		{
			AxisAlignedBB aabbW = AxisAlignedBB.getBoundingBox((double)(x), (double)(y), (double)(z + f1), (double)(x + f2), (double)(y + 1.2), (double)(z + f2));
		...
		if (east)
		{
			AxisAlignedBB aabbE = AxisAlignedBB.getBoundingBox((double)(x + f2), (double)(y), (double)(z + f1), (double)(x + 1), (double)(y + 1.2), (double)(z + f2));
    ...
    {
		if (par5Entity instanceof EntityLiving && !(par5Entity instanceof EntityPlayer) && !(par5Entity instanceof EntityTameable)
				&& !(par5Entity instanceof EntityVillager) && !(par5Entity instanceof EntityHorse))
        {
