...
public class BlockCordial extends BlockContainer{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else
        {
        	...
        	if (flag2){
        		par5EntityPlayer.addChatMessage(new ChatComponentText("This place is not suitable for creating a cordial."));
        	}
        	return true;
        }
    }
	...
	public void registerBlockIcons(IIconRegister par1IIconRegister)
	{
		...
		this.drinkIIcon = new IIcon[4];
		this.contentsIIcon = new IIcon[4];
		for (int i = 0; i < 4; ++i)
        {
