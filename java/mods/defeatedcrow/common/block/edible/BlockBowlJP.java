...
public class BlockBowlJP extends BlockContainer {
	...
	private static final String[] contents = new String[] { "_milk", "_tea_milk", "_soup", "_zousui", "_kayaku",
			"_soi", "_juice", "_BLTsoup", "_misosoup", "_clamsoup" };
		...
		if (itemstack == null) {
			if (currentMeta == 15) {
				if (!LoadBambooPlugin.getBasket().isEmpty() && LoadBambooPlugin.getBasket().get(0) != null) {
					ItemStack ret = LoadBambooPlugin.getBasket().get(0);
