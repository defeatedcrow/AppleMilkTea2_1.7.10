...
public class BlockCocktail extends BlockContainer {
	...
	public static final String[] contents = new String[] { "_milk", "_milk", "_milk", "_lime", "_cocoa", "_tomato",
			"_juice", "_lemon_gradient", "_lime", "_mintjulep", "_berry", "_berry_milk", "_tomato", "_tea", "_juice",
			"_juice_milk" };
