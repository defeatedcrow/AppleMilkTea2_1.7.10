...
public class BlockEvaporator extends BlockContainer {
	...
	public IIcon getIcon(int par1, int par2) {
		return par1 == 1 ? this.glassTex : (par1 == 0 ? this.blockIcon : this.baseTex);
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
		...
		TileEvaporator tile = (TileEvaporator) par1World.getTileEntity(par2, par3, par4);
		if (tile != null) {
			if (par1World.isRemote) {
				return true;
			} else {
				par5EntityPlayer.openGui(DCsAppleMilk.instance, DCsAppleMilk.instance.guiEvaporator, par1World, par2,
						par3, par4);
				return true;
			}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase,
		...
		if (tile != null && tile instanceof TileEvaporator) {
			((TileEvaporator) tile).setChargeAmount(charge);
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
		TileEvaporator tileentity = (TileEvaporator) par1World.getTileEntity(par2, par3, par4);
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		this.baseTex = par1IconRegister.registerIcon("defeatedcrow:teppann");
		this.glassTex = par1IconRegister.registerIcon("defeatedcrow:blueglass");
	}
