...
public class BlockAdvProsessor extends BlockContainer {
	
	protected Random rand = new Random();
	
	public BlockAdvProsessor()
	{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9){
		...
		TileAdvProsessor tile = (TileAdvProsessor)par1World.getTileEntity(par2, par3, par4);
		if (tile != null)
		{
			...
			{
				par5EntityPlayer.openGui(DCsAppleMilk.instance, DCsAppleMilk.instance.guiAdvProsessor, par1World, par2, par3, par4);
				return true;
			}
		}
		return true;
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
	{
		...
		if (tile != null && tile instanceof TileAdvProsessor)
		{
			((TileAdvProsessor)tile).setChargeAmount(charge);
