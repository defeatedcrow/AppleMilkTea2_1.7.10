...
public class BlockFilledPan extends BlockContainer {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
		...
		if (itemstack == null) {
			if (!par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(DCsAppleMilk.filledPan, 1,
					currentMeta))) {
	...
	public void registerBlockIcons(IIconRegister par1IIconRegister) {
		...
		for (int i = 0; i < 4; ++i) {
			int i2 = i & 3;
			this.contentsTex[i] = par1IIconRegister
					.registerIcon(Util.getTexturePassNoAlt() + "contents" + contents[i2]);
		}
	}
