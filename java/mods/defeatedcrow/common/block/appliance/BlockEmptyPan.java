...
public class BlockEmptyPan extends BlockContainer {
	...
	private int getMakerMeta(Item ID, int meta) {
		...
		if (ID == DCsAppleMilk.mincedFoods && meta == 3)
			m = 8;// rice
		else if (ID == DCsAppleMilk.mincedFoods && meta == 0)
			m = 9;// mushroom
		else if (ID == DCsAppleMilk.mincedFoods && meta == 1)
			m = 10;// stew
		else if (ID == DCsAppleMilk.mincedFoods && meta == 2)
			m = 11;// zousui
		else if (ID == DCsAppleMilk.mincedFoods && meta == 4)
			m = 8;// kayaku
		else if (ID == DCsAppleMilk.mincedFoods && meta == 5)
			m = 9;// tofu
		else if (ID == DCsAppleMilk.mincedFoods && meta == 6)
			m = 10;// pumpkin
		else if (ID == DCsAppleMilk.mincedFoods && meta == 7)
			m = 11;// BLT
		else if (ID == DCsAppleMilk.mincedFoods && meta == 8)
			m = 1;// choco
