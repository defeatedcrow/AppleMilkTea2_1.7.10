...
public class BlockProcessor extends BlockContainer {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
		...
		TileProcessor tile = (TileProcessor) par1World.getTileEntity(par2, par3, par4);
		if (tile != null) {
			if (par1World.isRemote) {
				return true;
			} else {
				par5EntityPlayer.openGui(DCsAppleMilk.instance, DCsAppleMilk.instance.guiProcessor, par1World, par2,
						par3, par4);
				return true;
			}
		}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase,
		...
		if (tile != null && tile instanceof TileProcessor) {
			((TileProcessor) tile).setChargeAmount(charge);
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6) {
		...
		if (tileentity != null) {
			...
			ItemStack block = new ItemStack(DCsAppleMilk.processor, 1, 0);
