...
//		}
	...
	public static void loadSS2Recipes(boolean flag)
	{
		...
		RecipeAPI.extractor.add(new ItemStack(Items.pumpkin_seeds, 1, 0), new ItemStack(DCsAppleMilk.dustWood, 1, 3),
				new FluidStack(DCsAppleMilk.vegitableOil, 2));
		RecipeAPI.extractor.add("soybeans", new ItemStack(DCsAppleMilk.dustWood, 1, 3),
				new FluidStack(DCsAppleMilk.vegitableOil, 100));
		RecipeAPI.extractor.add("rapeSeeds", new ItemStack(DCsAppleMilk.dustWood, 1, 3),
				new FluidStack(DCsAppleMilk.vegitableOil, 120));
