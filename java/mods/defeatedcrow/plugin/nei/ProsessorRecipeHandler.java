...
public class ProsessorRecipeHandler extends TemplateRecipeHandler {
	...
	public void loadTransferRects() {
	    transferRects.add(new TemplateRecipeHandler.RecipeTransferRect(new Rectangle(80, 25, 20, 20), "DCsProsessor"));
	}
	
	@Override
    public void loadCraftingRecipes(String outputId, Object... results)
    {
        if(outputId.equals("DCsProsessor"))
        {
	...
	public String getGuiTexture() {
		return "defeatedcrow:textures/gui/foodprosessorgui_nei.png";
	}
