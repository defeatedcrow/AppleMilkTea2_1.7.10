...
import mods.defeatedcrow.plugin.nei.ProsessorRecipeHandler.RecipeCacher;
...
public class AdvProsessorRecipeHandler extends TemplateRecipeHandler {
    ...
    {
        if(outputId.equals("DCsAdvProsessor"))
        {
