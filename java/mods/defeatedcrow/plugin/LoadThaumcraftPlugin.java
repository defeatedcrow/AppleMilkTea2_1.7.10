...
public class LoadThaumcraftPlugin {
	...
	public void integration()
	{
		...
		//tools
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.DCgrater), new int[]{32767}, new AspectList().add(Aspect.TOOL, 2).add(Aspect.ENTROPY, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.firestarter), new int[]{32767}, new AspectList().add(Aspect.TOOL, 2).add(Aspect.FIRE, 1).add(Aspect.FIRE, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.chalcedonyHammer), new int[]{32767}, new AspectList().add(Aspect.TOOL, 2).add(Aspect.CRYSTAL, 3));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.chalcedonyKnife), new int[]{32767}, new AspectList().add(Aspect.TOOL, 2).add(Aspect.CRYSTAL, 1).add(Aspect.WEAPON, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.pruningShears), new int[]{32767}, new AspectList().add(Aspect.TOOL, 2).add(Aspect.CRYSTAL, 1).add(Aspect.CROP, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.monocle), new int[]{32767}, new AspectList().add(Aspect.TOOL, 2).add(Aspect.CRYSTAL, 1).add(Aspect.SENSES, 1));
		...
		//magic
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.essentialOil), new int[]{32767}, new AspectList().add(Aspect.SENSES, 3));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseAgar), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.WATER, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseApple), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.FLIGHT, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseClam), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.LIFE, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseFrank), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.AURA, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseIce), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.COLD, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseLavender), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.MIND, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseMint), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.AIR, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseRose), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.HEAL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.incenseSandalwood), new int[]{0}, new AspectList().add(Aspect.SENSES, 1).add(Aspect.MAGIC, 1).add(Aspect.SOUL, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.princessClam), new int[]{0}, new AspectList().add(Aspect.MAGIC, 2).add(Aspect.WATER, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.princessClam), new int[]{1}, new AspectList().add(Aspect.MAGIC, 5).add(Aspect.HARVEST, 3));
		...
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.icyCrystal), new int[]{0}, new AspectList().add(Aspect.COLD, 3));
		
		//fruids
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.bottleCamOil), new int[]{0}, new AspectList().add(Aspect.WATER, 1).add(Aspect.PLANT, 1).add(Aspect.FIRE, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.bottleVegiOil), new int[]{0}, new AspectList().add(Aspect.WATER, 1).add(Aspect.PLANT, 1).add(Aspect.FIRE, 1));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.bucketCamOil), new int[]{0}, new AspectList().add(Aspect.WATER, 2).add(Aspect.PLANT, 1).add(Aspect.FIRE, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.bucketVegiOil), new int[]{0}, new AspectList().add(Aspect.WATER, 2).add(Aspect.PLANT, 1).add(Aspect.FIRE, 2));
		ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.bucketYoungAlcohol), new int[]{32767}, new AspectList().add(Aspect.WATER, 2).add(Aspect.SENSES, 1));
	    ...
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.cardboard), new int[]{0,1,2,3}, new AspectList().add(Aspect.CROP, 8));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.mobBlock), new int[]{0}, new AspectList().add(Aspect.FLESH, 5));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.mobBlock), new int[]{1}, new AspectList().add(Aspect.DEATH, 5));
	    ...
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.cLamp), new int[]{0,1,2,3}, new AspectList().add(Aspect.LIGHT, 2).add(Aspect.CRYSTAL, 3));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.cLamp), new int[]{4,5,6,7}, new AspectList().add(Aspect.LIGHT, 2).add(Aspect.CRYSTAL, 3).add(Aspect.VOID, 1));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.cLamp), new int[]{8}, new AspectList().add(Aspect.LIGHT, 2).add(Aspect.CRYSTAL, 3).add(Aspect.MIND, 2).add(Aspect.ENERGY, 2));
	    ...
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.prosessor), new int[]{0}, new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.ENTROPY, 3).add(Aspect.CRAFT, 2));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.advProsessor), new int[]{0}, new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.ENTROPY, 3).add(Aspect.METAL, 2));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.evaporator), new int[]{0}, new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.WATER, 2).add(Aspect.VOID, 2));
	    
	    //energy
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.yuzuBat), new int[]{0}, new AspectList().add(Aspect.ENERGY, 5).add(Aspect.CROP, 2));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.gelBat), new int[]{0}, new AspectList().add(Aspect.ENERGY, 5).add(Aspect.SLIME, 2));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.batBox), new int[]{0}, new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.ENERGY, 3).add(Aspect.EXCHANGE, 3));
	    ...
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.saplingYuzu), new int[]{OreDictionary.WILDCARD_VALUE}, new AspectList().add(Aspect.PLANT, 2).add(Aspect.ENERGY, 2));
	    ...
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.logYuzu), new int[]{OreDictionary.WILDCARD_VALUE}, new AspectList().add(Aspect.TREE, 2).add(Aspect.ENERGY, 2));
	    ThaumcraftApi.registerObjectTag(new ItemStack(DCsAppleMilk.leavesYuzu), new int[]{OreDictionary.WILDCARD_VALUE}, new AspectList().add(Aspect.PLANT, 1).add(Aspect.AIR, 1).add(Aspect.ENERGY, 1));
